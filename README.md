...
- Selected Projects is a 2x2 grid pointing at
  [order-saga](https://github.com/Jagdish1998/order-saga),
  [sql-guard-mcp](https://github.com/Jagdish1998/sql-guard-mcp),
  [llm-gateway](https://github.com/Jagdish1998/llm-gateway) and
  [linkedin-optimiser](https://github.com/Jagdish1998/linkedin-optimiser). Only the
  linkedin-optimiser card has a real screenshot; the other three are placeholder
  renders (`work-4-800.jpg` is generated by `make-work4-placeholder.ps1`).
- Only linkedin-optimiser has a live demo link. order-saga, sql-guard-mcp and
  llm-gateway need one once they are deployed.
